			...
			<br style="clear: both;" />
				...
				<form action="#" method="post">
					...
					<c:if test="${ inscrit == 'pbCarac'  }">
						<center><p style="color:red;"><strong>Le nom d'utilisateur ne doit pas être vide et le mot de passe doit être composé de 8 caracètres minimum.</strong></p></center>
					</c:if>
