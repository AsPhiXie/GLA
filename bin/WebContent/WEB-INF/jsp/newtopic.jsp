	...
	<body class="ltr">
		...
		<div id="wrapcentre">
			...
			<div id="pagecontent">
				...
				<table align="center" class="tablebg" style="margin-top: 5px;" cellspacing="1"
					cellpadding="0" width="50%">
					<tbody>
						<tr>
							<td class="row1">
								<center><strong>Titre du sujet:</strong><br/>
								<input type="text" name="name" value="${fn:escapeXml(param.name)}"/><br/></center>
							</td>
						</tr>
					</tbody>
				</table>
				<div style="margin-top: 15px;"><strong>Corps du message:</strong><br/>
